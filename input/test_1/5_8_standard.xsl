...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:ext="http://exslt.org/common" xmlns:svg="http://www.w3.org/2000/svg" xmlns:dgext="xalan://com.diatoz.graphics.GraphicsUtils" exclude-result-prefixes="fo">
  ...
  <xsl:template match="articles[@page=2]">
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      <fo:layout-master-set>
        <fo:simple-page-master master-name="simpleA4" page-height="272px" page-width="792px">
          <fo:region-body/>
        </fo:simple-page-master>
      </fo:layout-master-set>
      <fo:page-sequence master-reference="simpleA4">
        <fo:flow flow-name="xsl-region-body">
          <fo:block-container position="absolute" overflow="hidden" width="792px" height="272px" top="0px" left="0px" color="#000000" background-color="#FFFFFF">
            <fo:block line-height="0.9">
              <fo:instream-foreign-object>
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="792" height="272" viewBox="0 0 792 272" xml:space="preserve">
</svg>
              </fo:instream-foreign-object>
            </fo:block>
          </fo:block-container>
  ...
  <xsl:variable name="brand_str_1_1" select="articles/article[@index=1]/data/brand_STR"/>
  <xsl:variable name="brand_sch_1_1" select="articles/article[@index=1]/data/brand_SCH"/>
  <xsl:variable name="wine_region_str_1_1" select="articles/article[@index=1]/data/wine_region_STR"/>
  <xsl:variable name="wine_region_sch_1_1" select="articles/article[@index=1]/data/wine_region_SCH"/>
  <xsl:variable name="name_str_1_1" select="articles/article[@index=1]/data/name_STR"/>
  <xsl:variable name="name_sch_1_1" select="articles/article[@index=1]/data/name_SCH"/>
  <xsl:variable name="name2_str_1_1" select="articles/article[@index=1]/data/name2_STR"/>
  <xsl:variable name="name2_sch_1_1" select="articles/article[@index=1]/data/name2_SCH"/>
  <xsl:variable name="altcurunitprice_1_1" select="articles/article[@index=1]/data/altCurUnitPrice"/>
  <xsl:variable name="id_1_1" select="articles/article[@index=1]/data/id"/>
  <xsl:variable name="content_pack_str_1_1" select="articles/article[@index=1]/data/content_pack_STR"/>
  <xsl:variable name="content_pack_sch_1_1" select="articles/article[@index=1]/data/content_pack_SCH"/>
  <xsl:variable name="krlz_1_1" select="articles/article[@index=1]/data/KRLZ"/>
  <xsl:variable name="sales_flag_hq_str_1_1" select="articles/article[@index=1]/data/sales_flag_HQ_STR"/>
  <xsl:variable name="sales_flag_wh_str_1_1" select="articles/article[@index=1]/data/sales_flag_WH_STR"/>
  <xsl:variable name="sales_flag_hq_sch_1_1" select="articles/article[@index=1]/data/sales_flag_HQ_SCH"/>
  <xsl:variable name="sales_flag_wh_sch_1_1" select="articles/article[@index=1]/data/sales_flag_WH_SCH"/>
  <xsl:variable name="altcurprice_1_1" select="articles/article[@index=1]/data/altCurPrice"/>
  <xsl:variable name="description1_str_1_1" select="articles/article[@index=1]/data/description1_STR"/>
  <xsl:variable name="description1_sch_1_1" select="articles/article[@index=1]/data/description1_SCH"/>
  <xsl:template match="articles[@page=1]">
	...
	<g transform="translate(130 30)">
		<rect opacity="0" fill="rgb(255,255,255)" x="-125" y="-19" width="249" height="36"></rect>
		<text xml:space="preserve" font-family="LidlFontPro-Bold" font-size="30" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" text-rendering="optimizeLegibility" id="0"><xsl:call-template name="wordwrap">
<xsl:with-param name="productFieldValue" select="concat('', $brand_str_1_1, '', $brand_sch_1_1, '', $wine_region_str_1_1, '', $wine_region_sch_1_1)"></xsl:with-param>
...
<xsl:with-param name="fontFamily" select="&quot;LidlFontPro-Bold&quot;"></xsl:with-param>
<xsl:with-param name="fontWeight" select="1.0f"></xsl:with-param>
<xsl:with-param name="fontStyle" select="0.0f"></xsl:with-param>
<xsl:with-param name="fontSize" select="30"></xsl:with-param>
<xsl:with-param name="textWidth" select="249"></xsl:with-param>
<xsl:with-param name="textHeight" select="36"></xsl:with-param>
<xsl:with-param name="lineHeight" select="39.32399999999999"></xsl:with-param>
<xsl:with-param name="textLineHeight" select="34"></xsl:with-param>
<xsl:with-param name="tspanX" select="-125"></xsl:with-param>
<xsl:with-param name="tspanY" select="8.37"></xsl:with-param>
...
<xsl:with-param name="zeroformatEnabled" select="&quot;false&quot;"></xsl:with-param>
	...
	<g transform="translate(195 125)">
		<rect opacity="0" fill="rgb(255,255,255)" x="-190" y="-66" width="379" height="130"></rect>
		<text xml:space="preserve" font-family="LidlFontPro-Bold" font-size="44" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" text-rendering="optimizeLegibility" id="0"><xsl:call-template name="wordwrap">
<xsl:with-param name="productFieldValue" select="concat('', $name_str_1_1, '', $name_sch_1_1, '   ', $name2_str_1_1, '', $name2_sch_1_1)"></xsl:with-param>
<xsl:with-param name="currencyPosition" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencySign" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormat" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormatType" select="&quot;&quot;"></xsl:with-param>
...
<xsl:with-param name="fontWeight" select="1.0f"></xsl:with-param>
<xsl:with-param name="fontStyle" select="0.0f"></xsl:with-param>
<xsl:with-param name="fontSize" select="44"></xsl:with-param>
<xsl:with-param name="textWidth" select="379"></xsl:with-param>
<xsl:with-param name="textHeight" select="130"></xsl:with-param>
<xsl:with-param name="lineHeight" select="49.72"></xsl:with-param>
<xsl:with-param name="textLineHeight" select="50"></xsl:with-param>
<xsl:with-param name="tspanX" select="-190"></xsl:with-param>
<xsl:with-param name="tspanY" select="-26.32"></xsl:with-param>
<xsl:with-param name="textVertAlign" select="&quot;top&quot;"></xsl:with-param>
<xsl:with-param name="zeroformatEnabled" select="&quot;false&quot;"></xsl:with-param>
</xsl:call-template></text>
	</g>
	<g transform="translate(633 257)">
		<rect opacity="0" fill="rgb(255,255,255)" x="-142" y="-19" width="283" height="36"></rect>
		<text xml:space="preserve" font-family="LidlFontPro-Bold" font-size="22" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" text-rendering="optimizeLegibility" id="0"><xsl:call-template name="wordwrap">
<xsl:with-param name="productFieldValue" select="$altcurunitprice_1_1"></xsl:with-param>
<xsl:with-param name="currencyPosition" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencySign" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormat" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormatType" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyCode" select="&quot;&quot;"></xsl:with-param>         
<xsl:with-param name="textAnchor" select="&quot;end&quot;"></xsl:with-param>
<xsl:with-param name="fontFamily" select="&quot;LidlFontPro-Bold&quot;"></xsl:with-param>
<xsl:with-param name="fontWeight" select="1.0f"></xsl:with-param>
<xsl:with-param name="fontStyle" select="0.0f"></xsl:with-param>
<xsl:with-param name="fontSize" select="22"></xsl:with-param>
<xsl:with-param name="textWidth" select="283"></xsl:with-param>
<xsl:with-param name="textHeight" select="36"></xsl:with-param>
<xsl:with-param name="lineHeight" select="28.8376"></xsl:with-param>
<xsl:with-param name="textLineHeight" select="25"></xsl:with-param>
<xsl:with-param name="tspanX" select="141"></xsl:with-param>
<xsl:with-param name="tspanY" select="1.34"></xsl:with-param>
<xsl:with-param name="textVertAlign" select="&quot;top&quot;"></xsl:with-param>
<xsl:with-param name="zeroformatEnabled" select="&quot;false&quot;"></xsl:with-param>
</xsl:call-template></text>
	</g>
	<g transform="translate(244 246)">
		<rect opacity="0" fill="rgb(255,255,255)" x="-234" y="-15" width="466" height="28"></rect>
		<text xml:space="preserve" font-family="LidlFontPro-Bold" font-size="22" font-weight="bold" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" text-rendering="optimizeLegibility" id="0"><xsl:call-template name="wordwrap">
<xsl:with-param name="productFieldValue" select="concat('', $id_1_1, '  ', $content_pack_str_1_1, '', $content_pack_sch_1_1, '   ', $krlz_1_1, '   ', $sales_flag_hq_str_1_1, '', $sales_flag_wh_str_1_1, '', $sales_flag_hq_sch_1_1, '', $sales_flag_wh_sch_1_1)"></xsl:with-param>
<xsl:with-param name="currencyPosition" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencySign" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormat" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormatType" select="&quot;&quot;"></xsl:with-param>
...
<xsl:with-param name="fontStyle" select="0.0f"></xsl:with-param>
<xsl:with-param name="fontSize" select="22"></xsl:with-param>
<xsl:with-param name="textWidth" select="466"></xsl:with-param>
<xsl:with-param name="textHeight" select="28"></xsl:with-param>
<xsl:with-param name="lineHeight" select="28.8376"></xsl:with-param>
<xsl:with-param name="textLineHeight" select="25"></xsl:with-param>
<xsl:with-param name="tspanX" select="-234"></xsl:with-param>
<xsl:with-param name="tspanY" select="5.43"></xsl:with-param>
<xsl:with-param name="textVertAlign" select="&quot;top&quot;"></xsl:with-param>
<xsl:with-param name="zeroformatEnabled" select="&quot;false&quot;"></xsl:with-param>
</xsl:call-template></text>
	</g>
	<g transform="translate(556 130)">
		<rect opacity="0" fill="rgb(255,255,255)" x="-208" y="-109" width="415" height="216"></rect>
		<text xml:space="preserve" font-family="PoS Price Lidl Font Script Pro" font-size="180" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" text-rendering="optimizeLegibility" id="0"><xsl:call-template name="wordwrap">
<xsl:with-param name="productFieldValue" select="$altcurprice_1_1"></xsl:with-param>
<xsl:with-param name="currencyPosition" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencySign" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormat" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormatType" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyCode" select="&quot;&quot;"></xsl:with-param>         
<xsl:with-param name="textAnchor" select="&quot;end&quot;"></xsl:with-param>
<xsl:with-param name="fontFamily" select="&quot;PoS Price Lidl Font Script Pro&quot;"></xsl:with-param>
<xsl:with-param name="fontWeight" select="1.0f"></xsl:with-param>
<xsl:with-param name="fontStyle" select="0.0f"></xsl:with-param>
<xsl:with-param name="fontSize" select="180"></xsl:with-param>
<xsl:with-param name="textWidth" select="415"></xsl:with-param>
<xsl:with-param name="textHeight" select="216"></xsl:with-param>
<xsl:with-param name="lineHeight" select="235.94399999999996"></xsl:with-param>
<xsl:with-param name="textLineHeight" select="203"></xsl:with-param>
<xsl:with-param name="tspanX" select="207"></xsl:with-param>
<xsl:with-param name="tspanY" select="50.26"></xsl:with-param>
<xsl:with-param name="textVertAlign" select="&quot;bottom&quot;"></xsl:with-param>
<xsl:with-param name="zeroformatEnabled" select="&quot;false&quot;"></xsl:with-param>
</xsl:call-template></text>
	</g>
	<g transform="translate(183 202)">
		<rect opacity="0" fill="rgb(255,255,255)" x="-173" y="-19" width="344" height="36"></rect>
		<text xml:space="preserve" font-family="LidlFontPro-Bold" font-size="21" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" text-rendering="optimizeLegibility" id="0"><xsl:call-template name="wordwrap">
<xsl:with-param name="productFieldValue" select="concat('', $description1_str_1_1, '', $description1_sch_1_1)"></xsl:with-param>
<xsl:with-param name="currencyPosition" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencySign" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormat" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormatType" select="&quot;&quot;"></xsl:with-param>
...
<xsl:with-param name="fontWeight" select="1.0f"></xsl:with-param>
<xsl:with-param name="fontStyle" select="0.0f"></xsl:with-param>
<xsl:with-param name="fontSize" select="21"></xsl:with-param>
<xsl:with-param name="textWidth" select="344"></xsl:with-param>
<xsl:with-param name="textHeight" select="36"></xsl:with-param>
<xsl:with-param name="lineHeight" select="27.526799999999998"></xsl:with-param>
<xsl:with-param name="textLineHeight" select="24"></xsl:with-param>
<xsl:with-param name="tspanX" select="-173"></xsl:with-param>
<xsl:with-param name="tspanY" select="0.46"></xsl:with-param>
<xsl:with-param name="textVertAlign" select="&quot;top&quot;"></xsl:with-param>
<xsl:with-param name="zeroformatEnabled" select="&quot;false&quot;"></xsl:with-param>
</xsl:call-template></text>
	</g>
	<g transform="translate(181 226)">
		<rect opacity="0" fill="rgb(255,255,255)" x="-172" y="-19" width="341" height="36"></rect>
		<text xml:space="preserve" font-family="LidlFontPro-Bold" font-size="21" style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 4; fill: rgb(0,0,0); fill-rule: nonzero; opacity: 1; white-space: pre;" text-rendering="optimizeLegibility" id="0"><xsl:call-template name="wordwrap">
<xsl:with-param name="productFieldValue" select="concat('', $content_pack_str_1_1, '', $content_pack_sch_1_1)"></xsl:with-param>
<xsl:with-param name="currencyPosition" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencySign" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormat" select="&quot;&quot;"></xsl:with-param>
<xsl:with-param name="currencyFormatType" select="&quot;&quot;"></xsl:with-param>
...
<xsl:with-param name="fontStyle" select="0.0f"></xsl:with-param>
<xsl:with-param name="fontSize" select="21"></xsl:with-param>
<xsl:with-param name="textWidth" select="341"></xsl:with-param>
<xsl:with-param name="textHeight" select="36"></xsl:with-param>
<xsl:with-param name="lineHeight" select="27.526799999999998"></xsl:with-param>
<xsl:with-param name="textLineHeight" select="24"></xsl:with-param>
<xsl:with-param name="tspanX" select="-172"></xsl:with-param>
<xsl:with-param name="tspanY" select="0.46"></xsl:with-param>
<xsl:with-param name="textVertAlign" select="&quot;top&quot;"></xsl:with-param>
<xsl:with-param name="zeroformatEnabled" select="&quot;false&quot;"></xsl:with-param>
</xsl:call-template></text>
